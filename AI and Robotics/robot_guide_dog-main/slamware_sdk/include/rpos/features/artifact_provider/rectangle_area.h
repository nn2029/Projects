...
namespace rpos { namespace features { namespace artifact_provider {
        ...
        // restricted area
        static const char MetaDataKey_RestrictedFrontSchedulingPoints[] = "restricted_front_scheduling_points";
        static const char MetaDataKey_RestrictedRearSchedulingPoints[] = "restricted_rear_scheduling_points";
